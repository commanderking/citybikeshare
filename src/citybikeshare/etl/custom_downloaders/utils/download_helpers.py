...
def should_download(target_path, *, label=None):
    ...
    downloaders for immutable files. It's the single place to change if the download
    step ever needs content-aware checks (e.g. hashing) instead of filename presence.
    """
